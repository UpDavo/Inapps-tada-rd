...
export class CatchingComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    var garbage_images = [['/assets/img/bomb.png', '-6px', '-57px', '2.4rem']];
    ...
    Swal.fire({
      title:
        "<h3 style='font-size:2.2rem;font-family: Bright !important; color: #270a45;'>¿Quieres ganarte una cerveza retornable?<h3>",
      html: `<h3 style='font-size:0.9rem;font-family: Monserrat !important;'>Atrapa <b>5 cervezas retornables</b> y recibe la sexta gratis con un cupón 🍻</h3>`,
      imageUrl: '/assets/img/logo_tada.png',
